...
namespace SyncfusionWpfApp1.repo
{
    public class MainRepository
    {
        ...
        static MainRepository()
        {
            ...
            Ticket ticket1 = new Ticket(1,client1, false, tl1, new DateTime(2022, 06, 9, 9, 0, 0), seats[0], null, t1, ts1, ts6, 1200, new DateTime(2022, 06, 9, 10, 0, 0)); // PODACI ZA FROM I TO ATRIBUTE SU STAVLJENI BEZ PROVERE DA LI IMAJU SMISLA
